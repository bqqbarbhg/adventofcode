...
int main(int argc, char **argv)
{
	...
	for (inv_prefix = 0; inv_prefix < full_prefix; inv_prefix++) {
		int prefix = full_prefix - inv_prefix;
		bool bad = false;

		if (prefix < max_prefix) bad = true;
